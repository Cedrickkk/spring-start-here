package org.spring.framework.sqch12ex2.repositories;
...
public class PurchaseRepository {
    ...
    public List<Purchase> findAll() {
        ...
        RowMapper<Purchase> purchaseRowMapper = (rowSet, i) -> {
            Purchase rowObject = new Purchase();
            rowObject.setId(rowSet.getInt("id"));
            rowObject.setProduct(rowSet.getString("product"));
            rowObject.setPrice(rowSet.getBigDecimal("price"));
            return rowObject;
        };
