...
public class LoggingAspect {
    ...
    @Before("@annotation(annotations.ToLogBefore)")
    public void before() {
        logger.info("Performing this operation BEFORE the pointcut");
    }

    @After("@annotation(annotations.ToLogAfter)")
    public void after() {
        logger.info("Performing this operation AFTER the pointcut");
    }
